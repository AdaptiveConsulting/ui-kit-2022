      ...
      <Container maxWidth={false}>
        <Box mt={5}>
          ...
          <Typography variant="body2">
            ...
            sections. They can also be part of data visualizations and can provide a sense
            of scale to charts.
            <br />
            <br />
            ...
            <Grid item md={2} xs={12}>
              <Box>
                ...
                <Typography variant="body2">
                  ...
                  use of space also should also tell the user how you have separated your
                  content.
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  The <b>bold</b> divider style is for uses that are essential to function
                  and comprehension, such as the axes of a graph. It is set at 80% opacity
                  for the color. These should have at least a 3:1 contrast ratio against
                  their backgrounds.
                </Typography>
              </Box>
            </Grid>
            ...
            <Grid item md={2} xs={12}>
              <Box>
                ...
                <Typography variant="body2">
                  ...
                  pixels of space above and below a horizontal divider, or left/right of a
                  vertical one. A dotted line in an accent color might be useful in graphs
                  and charts.
                </Typography>
              </Box>
            </Grid>
          ...
          <Grid container columnSpacing={5} rowSpacing={5}>
            ...
            <Grid item md={8.5} xs={12}>
              <Box>
                ...
                <Typography
                  variant="caption"
                  color={palette.mode === 'dark' ? palette.grey[300] : palette.grey[500]}
                  lineHeight={'1.3'}
                  display="block"
                  mb={6}
                >
