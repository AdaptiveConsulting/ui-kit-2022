export { ReactComponent as LogoFull } from './images/logo_full.svg';
...
export { ReactComponent as LogoText } from './images/logo_text.svg';

export const darkLogoColor = '#323232';
export const lightLogoColor = '#fff';
